...
|---:|---:|---:|---:|---:|---:|
| 2 | 7.19 | 2224 | 3.90× | 4.00× | 0.10 |
| 4 | 11.78 | 1359 | 2.38× | 2.40× | 0.02 |
| 6 | 16.38 | 977 | 1.71× | 1.71× | 0.00 |
| 8 | 21.01 | 761 | 1.34× | 1.33× | -0.00 |
| 10 | 25.70 | 623 | 1.09× | 1.09× | -0.00 |
| 11 | 28.07 | 570 | 1.00× | 1.00× | 0.00 |

- 完整 12 层 p50 范围：7.69–107.58 ms（随长度/batch）。实测加速与理论层数比
  12/(k+1) 高度接近（浅层差距 ~0.1×，深层 ~0），说明固定层退出的真实加速基本贴合
  层数节省；小批量下存在固定开销，差距随批增大进一步缩小。
